...
test("property descriptor writable attribute", () => {
  const obj = {};
  ...
  // Non-writable property cannot be changed (silently fails in non-strict mode)
...
test("property descriptor enumerable attribute", () => {
  const obj = {};
...
test("property descriptor configurable attribute", () => {
  const obj = {};
...
test("getter and setter descriptors", () => {
  const obj = {};
  let internalValue = 0;
...
test("property descriptor inheritance and shadowing", () => {
  const parent = {};
...
test("property descriptor with symbol keys", () => {
  const obj = {};
...
test("property descriptor default values", () => {
  const obj = {};
...
test("property descriptor modification constraints", () => {
  const obj = {};
