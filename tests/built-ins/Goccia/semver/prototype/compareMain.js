/*---
description: semver.SemVer.prototype.compareMain compares only major, minor, and patch
features: [semver.SemVer]
---*/

import * as semver from "goccia:semver";

describe("semver.SemVer.prototype.compareMain", () => {
  test("compareMain ignores prerelease metadata", () => {
    const version = new semver.SemVer("1.2.3-alpha.1");
