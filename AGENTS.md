...
- Write test names, descriptions, and suite titles in **user-facing terms** because the TestRunner prints them directly. Describe observable JavaScript or CLI behavior, not Pascal implementation details or internal type names, unless that internal contract is itself the public surface under test.
