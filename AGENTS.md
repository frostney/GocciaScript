...
| GocciaScript Backend | `Goccia.Engine.Backend.pas` | `TGocciaSouffleBackend` — bridges GocciaScript engine to Souffle VM; initializes `TGarbageCollector` (automatic collection disabled), collects on destruction, shuts down in `finalization` |
