...
| `Symbol.customMatcher` | Well-known symbol for pattern matching. Objects can define `[Symbol.customMatcher](subject, hint)` and return a truthy/falsy value for value-pattern matching. |
