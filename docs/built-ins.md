...
These are **not** available as global functions — see [language.md](language.md#no-global-parseint-parsefloat-isnan-isfinite) for the rationale and polyfill pattern.
