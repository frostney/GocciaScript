...
- **Conformance-only host hooks** — `GocciaTest262Runner` exposes private test262 hooks (`eval`, `evalScript`, `createRealm`) without making them part of the public runtime surface
