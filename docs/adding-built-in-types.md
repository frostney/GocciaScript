...
- [ ] Build succeeds (`./build.pas --clean runner`)
...
6. **Stale build artifacts** -- After adding new units, run `./build.pas --clean runner` to avoid FPC internal errors from stale `.ppu` files.
