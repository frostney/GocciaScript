...
- No conformance change: the full JavaScript suite passes in both modes, and test262 `language` regex/division/template-literal/arrow-function/asi areas pass 100% on the bytecode VM — expected, since classification is preserved exactly.
