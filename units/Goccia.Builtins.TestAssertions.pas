...
type
  ...
  public
    ...
    SuiteName: string;
    IsSkipped: Boolean;
    constructor Create(const AName: string; const ATestFunction: TGocciaFunctionValue; const ASuiteName: string; const AIsSkipped: Boolean = False);
  end;
...
begin
  ...
  if not (AArgs.GetElement(0) is TGocciaFunctionValue) then
