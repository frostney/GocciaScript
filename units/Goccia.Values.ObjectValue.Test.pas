...
uses
  Goccia.Values.Base, Goccia.Values.ObjectValue, Goccia.Values.StringValue, Goccia.Values.NumberValue, Goccia.Values.BooleanValue, StrUtils, Math, TestRunner;
...
begin
  ...
  ObjectValue.SetProperty('name', TGocciaStringValue.Create('John'));
  ObjectValue.SetProperty('age', TGocciaNumberValue.Create(30));
  ObjectValue.SetProperty('isStudent', TGocciaBooleanValue.Create(True));
  ObjectValue.SetProperty('address', TGocciaStringValue.Create('123 Main St'));
  ObjectValue.SetProperty('city', TGocciaStringValue.Create('Anytown'));
  ObjectValue.SetProperty('state', TGocciaStringValue.Create('CA'));
  ObjectValue.SetProperty('zip', TGocciaStringValue.Create('12345'));
...
begin
  Result := TGocciaStringValue.Create(AObject.GetProperty('name').ToString + ' ' + AObject.GetProperty('lastName').ToString);
end;
...
begin
  ...
  ObjectValue.SetProperty('name', TGocciaStringValue.Create('Jane'));
...
begin
  ...
  Prototype.SetProperty('name', TGocciaStringValue.Create('Jane'));
...
begin
  ...
  ObjectValue.SetProperty('name', TGocciaStringValue.Create('Jane'));
  ObjectValue.Prototype.SetProperty('name', TGocciaStringValue.Create('John'));
  ObjectValue.Prototype.Prototype.SetProperty('name', TGocciaStringValue.Create('Joseph'));
...
begin
  ...
  ObjectValue.SetProperty('lastName', TGocciaStringValue.Create('Doe'));
