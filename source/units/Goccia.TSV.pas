...
class function TGocciaTSVParser.HasByteOrderMark(
...
begin
  ...
  if (EffectiveStart = 0) and HasByteOrderMark(AText) then
    Inc(EffectiveStart, BYTE_ORDER_MARK_CODE_UNIT_LENGTH);
