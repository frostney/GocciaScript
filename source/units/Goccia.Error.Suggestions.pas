...
resourcestring
  ...
  SSuggestDecoratorsOnlyClasses = 'Decorators can only be applied to class declarations, class expressions, or class elements';
  ...
  SSuggestToPrimitiveNotCallable = 'make [Symbol.toPrimitive] a function, or remove it to fall back to valueOf()/toString()';
