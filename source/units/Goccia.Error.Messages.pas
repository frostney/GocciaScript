...
resourcestring
  ...
  SErrorRoundingIncrementMax = 'roundingIncrement must be <= 1000000000';
  ...
  SErrorFFINullableRequiresType = 'FFI.nullable requires a wrapped type';
  SErrorFFINullableUTF8StringOnly = 'FFI.nullable currently supports only utf8string';
  SErrorFFINullableArgumentOnly = 'FFI nullable types are only valid as bound native-function arguments';
  SErrorFFIVarArgsRequiresArrays = 'FFI.varargs requires type and value arrays';
  SErrorFFIVarArgsArrays = 'FFI.varargs types and values must be arrays';
  SErrorFFIVarArgsLength = 'FFI.varargs types and values must have the same length';
  SErrorFFIMetadataRequiresAggregate = 'FFI.metadata requires an FFI aggregate value';
  ...
  SErrorFFICallbackVariadicUnsupported = 'FFI callbacks cannot be variadic';
  ...
  SErrorFFIVariadicFlagBoolean = 'signature variadic must be a boolean';
  SErrorFFIVariadicTailRequired = 'Variadic FFI function %s requires one FFI.varargs(types, values) tail argument';
  SErrorFFIVariadicArgumentLimit = 'FFI function %s exceeds the maximum of %d total arguments';
  ...
  SErrorFFINullableUTF8StringArgument = 'FFI nullable utf8string argument must be a string or null and contain well-formed UTF-16 without embedded NUL';
  ...
  SErrorRegExpExecNotCallable = 'RegExp exec method must be callable';
