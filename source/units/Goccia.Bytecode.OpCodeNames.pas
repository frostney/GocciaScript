...
begin
  case TGocciaOpCode(AOp) of
    ...
    OP_VALIDATE_IMPORT_BINDING:        Result := 'OP_VALIDATE_IMPORT_BINDING';
    ...
    OP_DEFINE_GLOBAL_VAR_LONG:         Result := 'OP_DEFINE_GLOBAL_VAR_LONG';
    OP_DEFINE_GLOBAL_LET_LONG:         Result := 'OP_DEFINE_GLOBAL_LET_LONG';
    OP_DEFINE_GLOBAL_CONST_LONG:       Result := 'OP_DEFINE_GLOBAL_CONST_LONG';
